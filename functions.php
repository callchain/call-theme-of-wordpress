...
CallChain是基于区块链技术的去中心化泛娱乐平台，为全球泛娱乐社区提供价值流通枢纽。<br/>在这个平台上，观众、粉丝、影迷、歌迷、娱乐达人等，均可以深度参与到娱乐的方方面面，<br/>    真正实现为爱豆打Call，为自己打Call！';
        ...
        $arr['faq7']           = 'CallChain创始人杨建新先生，是团队的灵魂人物。清华大学计算机硕士，是国内最早的区块链开发专家之一、区块链底层构架师，曾主导了国内第一条商业公有链的开发，是国内智能合约最早落地的先驱者，也是井通区块链底层平台国内负责人（CTO 首席技术官）。
CallChain邀请国内外著名区块链行业及泛娱乐行业的专家，和具有丰富市场实战经验的职场精英，组成了一支活力、高效、激情的团队，秉持着区块链精神，去中心化、公平、公正、开放、透明、包容、信任，专注于区块链技术在泛娱乐的推广、应用以及落地，基于中国市场并面向全球扩张。';
...
随着CallChain的发展，在未来，我们相信还会有更多潜在有价值的场景应用不断涌现。';
    ...
    else
    {
        ...
        $arr['faq7']           = "Mr. Yang Jianxin, founder of CallChain, is the soul of the team. Tsinghua University's master of computer science is one of the earliest blockchain development experts in China, and the blockchain underlying architect. It has led the development of the first commercial public chain in China. It is the earliest pioneer of domestic smart contracts and well-known. Domestic leader of the blockchain bottom platform (CTO).
        CallChain invites experts from the famous blockchain industry and the pan-entertainment industry at home and abroad, as well as the elites with rich experience in market practice, to form a dynamic, efficient and passionate team, adhering to the spirit of blockchain, decentralized and fair. Fair, open, transparent, inclusive, and trustful, focusing on the promotion, application, and landing of blockchain technology in pan-intelligence, based on the Chinese market and expanding globally.";
